    ...
    private func createItinerary() {
        ...
        Task {
            do {
                ...
                // Handle guardrail violations specifically
                    ...
                    VStack(spacing: 12) {
                        ...
                        VStack(spacing: 8) {
                            ...
                            if !(planner.titulo != nil && planner.descripcion != nil) {
                                SearchStatusView(
                                    title: "Searching title and description...",
                            ...
                            if planner.tituloMapa == nil {
                                SearchStatusView(
                                    title: "Searching map information...",
                            ...
                            // Solo mostrar si no está completado
                            if !(planner.lugar1 != nil && planner.lugar2 != nil) {
                                SearchStatusView(
                                    title: "Searching recommended places...",
                                    isCompleted: planner.lugar1 != nil && planner.lugar2 != nil,
                                    isGenerating: planner.lugar1 == nil && planner.tituloMapa != nil && isGenerating
                                )
                                .transition(.opacity.combined(with: .scale(scale: 0.95)))
                            }
                            
                            // Solo mostrar si no está completado
                            if planner.actividad == nil {
                                SearchStatusView(
                                    title: "Searching special activities...",
                                    isCompleted: planner.actividad != nil,
                                    isGenerating: planner.actividad == nil && planner.lugar1 != nil && isGenerating
                                )
                                .transition(.opacity.combined(with: .scale(scale: 0.95)))
                            }
                        }
